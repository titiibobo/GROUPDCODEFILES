...
function submit_check()
{
	...
	var pass = document.forms[0].elements[4].value;
	var user_name = document.forms[0].elements[5].value;
	var phone = document.forms[0].elements[7].value;
	//var button = document.forms[0].elements[8].value;
	var button = document.getElementById("submitbutton");
if ((firstname.length>0) && (lastname.length>0) && (email1.length>0) && (email2.length>0) && (pass.length>0) && (user_name.length>0) && (phone.length>0))
	{
...
{
	var password = document.forms[0].elements[4].value;
	...
	{
	alert("Your password must be at least 6 characters long. Please ensure you password is up to 6 characters long before attempting to use the submit button");
	}
...
checkallfields()
{
	 ...
	 var uname = document.forms[0].elements[5].value;
	 if (uname.length<1)
	{
	 //document.getElementById("submitbutton").disabled = true;
	 var area_content = document.getElementById("buttonarea");
	 area_content = "Hello";
	}
}
</script>      
...
<br />
<div align="center">
<h2 style="color:red;">Sorry, the details entered are invalid</h2>
<!-- <div align="center"><h3><u>Registration Form</u></h3></div> -->
<!-- <div align="center"><h4><u>Try again using the form below!</u></h4></div> -->

<!-- <div align="center" id="maindiv">
<form  role="form" name="form1" method="POST" action="process_registration.php">
                                                <table width="95%" border="0" align="center"> 
                                                  <tr>
                                                    <td width="50%"><div align="right">
                                                      <input id="firstname" type="text" onMouseOut="firstNameCheck(document.form1.firstname)" class="form-control" name="firstname" value="" placeholder="First Name">
                                                    </div></td>
                                                    <td width="50%" rowspan="7"><img src="receptionist.jpg" width="384" height="454" alt="receptionist"></td>
                                                  </tr>
                                                  <tr>
                                                    <td><div align="right">
                                                      <input id="lastname" type="text" class="form-control" name="lastname" value="" placeholder="Last Name"  onMouseOut="lastNameCheck(document.form1.lastname)">
                                                    </div></td>
                                                  </tr>
                                                  <tr>
                                                    <td><div align="right">
                                                  ...
                                                  <tr>
                                                    <td><div align="right">
                                                      <input id="email" type="text" class="form-control" name="confirmemail" value="" placeholder="Confirm Email" onMouseOut="return check_email()" >
                                                    </div></td>
                                                  <tr>
                                                    <td><div align="right">
                                                  ...
                                                  <tr>
                                                    <td><div align="right">
                                                      <input id="username" type="text" class="form-control" name="username" placeholder="Username" onMouseOut="return check_username()">
                                                    </div></td>
                                                  </tr>
                                                  <tr>
                                                    <td><div align="right">
...
<option data-countryCode="DZ" value="213">Algeria (+213)</option>
		...
		<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>                                                  </select>
                                                  <input id="phone" type="text" class="form-control" name="phone" placeholder="Phone Number" onMouseOut="return submit_check()">
                                                    </div>
                                                    </td>
                                                  </tr>
                                                  <tr>
                                                    <td colspan="2" align="center"><span style="float:center;" id="buttonarea"><button type="submit" class="btn btn-custom" id="submitbutton" onMouseOver="return submit_check()" style="background-color:#060; font-weight:bold; color:#FFF;" disabled>Submit</button></span>
</td>
                                                  </tr>
                                                </table>
</form> -->
