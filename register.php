...
function check_email()
{
	...
	if (email2.length<1)
	{
	alert("The Confirm Email field cannot be left blank. Please, input email.");
	}
	if (email1 !== email2) 
		    {
...
<body background="">  
<br />
<div align="center"><h3>Create your account</h3></div>
...
<form  role="form" name="form1" method="POST" action="process_registration.php">
                                                <table width="95%" border="0" align="center"> 
                                                  <tr>
                                                    ...
                                                    <td width="50%" rowspan="7"><img src="receptionist.jpeg" width="384" height="454" alt="receptionist"></td>
                                                  </tr>
                                                  <tr>
                                                    <td><div align="right">
